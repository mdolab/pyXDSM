...
% Component types
\tikzstyle{Optimization} = [rounded rectangle,draw,fill=tableau0!50,inner sep=6pt,minimum height=1cm,text badly centered]
\tikzstyle{LP_Optimization} = [rectangle,draw,fill=tableau0!50,inner sep=6pt,minimum height=1cm,text badly centered]
\tikzstyle{Analysis} = [rectangle,draw,fill=tableau4!50,inner sep=6pt,minimum height=1cm,text badly centered]
...
\tikzstyle{MDA} = [rounded rectangle,draw,fill=tableau1!50,inner sep=6pt,minimum height=1cm,text badly centered]
\tikzstyle{Metamodel} = [rectangle,draw,fill=tableau5!50,inner sep=6pt,minimum height=1cm,text badly centered]
