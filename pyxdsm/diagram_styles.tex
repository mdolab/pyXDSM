...
% Component types
\tikzstyle{Optimization} = [rounded rectangle,draw,fill=tableau0!30,inner sep=6pt,minimum height=1cm,text badly centered]
...
\tikzstyle{Function} = [rectangle,draw,fill=tableau3!50,inner sep=6pt,minimum height=1cm,text badly centered]
\tikzstyle{MDA} = [rounded rectangle,draw,fill=tableau8!50,inner sep=6pt,minimum height=1cm,text badly centered]
