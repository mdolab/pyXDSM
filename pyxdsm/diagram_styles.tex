...
\definecolor{tableau6}{RGB}{0, 0, 255}
...
% Component types
\tikzstyle{Optimization} = [rounded rectangle,draw,fill=tableau6!50,inner sep=6pt,minimum height=1cm,text badly centered]
\tikzstyle{LP_Optimization} = [rectangle,draw,fill=tableau6!50,inner sep=6pt,minimum height=1cm,text badly centered]
