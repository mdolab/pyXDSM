...
% --------- Overridden component types --------------
\tikzstyle{Function} = [\compShape, rounded corners=2mm, draw=\explicitColor!\lineOpacity, fill=\explicitColor!\fillOpacity, line width=1.5pt, inner sep=6pt, text badly centered]
\tikzstyle{ImplicitFunction} = [\compShape, rounded corners=2mm, draw=\implicitColor!\lineOpacity, fill=\implicitColor!\fillOpacity, line width=1.5pt, inner sep=6pt, text badly centered]
% --------- Overridden component types --------------
...
% ----- Modified data types ----------
\tikzstyle{DataInter} = [draw=black!60, line width=1.5pt, trapezium, trapezium left angle=\dataLeftAngle, trapezium right angle=\dataRightAngle,draw, fill=black!10]
\tikzstyle{DataIO} = [draw=\dataColor, line width=1.5pt, trapezium, trapezium left angle=\dataLeftAngle, trapezium right angle=\dataRightAngle, draw, fill=\dataColor!\fillOpacity]
% ----- Modified data types ----------
...
% -------- Modified edge  --------
\tikzstyle{DataLine} = [color=black!40, line width=3pt, line cap=rect]
% -------- Modified edge  --------
